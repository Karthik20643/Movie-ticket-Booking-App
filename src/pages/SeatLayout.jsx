    ...
    <div className='flex flex-col gap-8 px-6 py-30 md:flex-row md:px-16 md:pt-50 lg:px-40'>
      <div className='h-max w-60 rounded-lg border border-primary/20 bg-primary/10 py-10 md:sticky md:top-30'>
        ...
        {timings.map((item) => (
          <div
            ...
            className={`flex w-max cursor-pointer items-center gap-2 rounded-r-md px-6 py-2 transition ${selectedTime?.time === item.time ? 'bg-primary/20' : ''}`}
          >
      ...
      <div className='relative flex flex-1 flex-col items-center max-md:mt-16'>
        ...
        <div className='mb-4 flex w-full max-w-4xl flex-col items-center'>
          ...
          <p className='mt-2 text-sm text-gray-400'>SCREEN THIS SIDE</p>
        </div>
